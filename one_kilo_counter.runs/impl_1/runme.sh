...
HD_PWD='C:/Users/Saurav Kumar/one_kilo_counter/one_kilo_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log one_kilo_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source one_kilo_counter.tcl -notrace
