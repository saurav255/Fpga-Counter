...
HD_PWD='C:/Users/Saurav Kumar/one_kilo_counter/one_kilo_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_kilo_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_kilo_counter.tcl
